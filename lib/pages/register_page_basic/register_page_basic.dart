                      ...
                      subtitle: Card(
                        child: Consumer<PxAppConstants>(
                          builder: (context, a, _) {
                            ...
                            return DropdownButtonFormField<SiteService>(
                              validator: (value) {
                                if (value == null) {
                              ...
                              items: a.model?.site_services.map((e) {
                                return DropdownMenuItem<SiteService>(
                                  alignment: Alignment.center,
                                  value: e,
                                  child: Text(
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return context
                                    .loc.confirmPasswordEnterValidator;
                              }
                              if (_passwordController.text !=
                                  _confirmPasswordController.text) {
                                return context
                                    .loc.confirmPasswordMatchValidator;
                              }
                              return null;
                            },
                          ),
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              final UserModel _model = UserModel(
                                id: '',
                                username: _syndIdController.text,
