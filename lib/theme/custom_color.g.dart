...
const customcolor1 = Color(0xFF168AAD);
const customcolor2 = Color(0xFFD9ED92);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF168AAD),
  customcolor1: Color(0xFF006782),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFBBE9FF),
  onCustomcolor1Container: Color(0xFF001F29),
  sourceCustomcolor2: Color(0xFFD9ED92),
  customcolor2: Color(0xFF536600),
  onCustomcolor2: Color(0xFFFFFFFF),
  customcolor2Container: Color(0xFFD5ED7E),
  onCustomcolor2Container: Color(0xFF171E00),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF168AAD),
  customcolor1: Color(0xFF61D4FF),
  onCustomcolor1: Color(0xFF003545),
  customcolor1Container: Color(0xFF004D63),
  onCustomcolor1Container: Color(0xFFBBE9FF),
  sourceCustomcolor2: Color(0xFFD9ED92),
  customcolor2: Color(0xFFB9D165),
  onCustomcolor2: Color(0xFF2A3500),
  customcolor2Container: Color(0xFF3E4C00),
  onCustomcolor2Container: Color(0xFFD5ED7E),
);
